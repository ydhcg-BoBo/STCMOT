...
def gen_track_dataset(src_root, dst_root, viz_root=None):
    ...
    for seq in tqdm(seq_names):
        ...
        seq_obj_boxes = seq_label_array[(seq_label_array[:, 7] > 0) & (seq_label_array[:, 7] < 4)]  # np条件索引
...
if __name__ == '__main__':
    gen_track_dataset(src_root='/media/jianbo/ioe/UVAdata/uvadt/test',
                      dst_root='/media/jianbo/ioe/UVAdata/UAVDT_fmot/test',
                      viz_root='/media/jianbo/ioe/UVAdata/UAVDT_test_vis')
    gen_dot_train_file(data_root='/media/jianbo/ioe/UVAdata/', rel_path='UAVDT_fmot/test/images',
                      out_root='/media/jianbo/ioe/UVAdata/', f_name='UAVDT.test')
    # gen_dot_train_file(data_root = '/media/ls/ba8e1116-1f86-466a-a781-a60f5e5a83ef/kyq/dataset/', rel_path='UAVDT_fmot/train/images',
    #                   out_root='/home/ls/code/MCMOT_exp/src/data', f_name='UAVDT.train')
    # gen_dot_train_file(data_root = '/media/ls/FA5ECF148688E396/DataSet/', rel_path='visdrone_fmot/val/images',
    #                   out_root='/home/ls/code/Tracking/MCMOT/src/data', f_name='visdrone.val')
    #gen_dot_train_file(data_root = '/media/ls/FA5ECF148688E396/DataSet/', rel_path='visdrone_fmot/trainval/images',
    #                   out_root='/home/ls/code/Tracking/MCMOT/src/data', f_name='visdrone.trainval')
    # gen_dot_train_file(data_root = '/media/ls/FA5ECF148688E396/DataSet/', rel_path='visdrone/test/sequences',
    #                    out_root='/home/ls/code/Tracking/MCMOT/src/data', f_name='visdrone.test')